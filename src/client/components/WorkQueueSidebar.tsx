...
export function WorkQueueSidebar({
  ...
  function jobRow(
    ...
    const cls = [
      'sidebar-job',
      isActive ? 'sidebar-job-active' : `sidebar-job-${job.status}`,
  ...
  return (
    <aside className="sidebar">
      ...
      {hasActive && (
        <div className="sidebar-section">
          <div className="sidebar-section-header">
            <span className="sidebar-section-label">active ({active.length})</span>
            <button
      ...
      {hasQueued && (
        <div className="sidebar-section">
          <div className="sidebar-section-header">
            <span className="sidebar-section-label">queued ({queued.length})</span>
            <button
              className="sidebar-section-folder-btn"
