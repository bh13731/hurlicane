    ...
    <header className="header">
      ...
      <div className={`header-actions${headerMenuOpen ? ' header-actions-open' : ''}`}>
        <input
          ...
          placeholder="Search..."
          readOnly
          onFocus={() => { onSearch(); closeMenu(); }}
        />
        <span className="header-divider" />
        <div className="header-btn-group" title="Visualizations">
          <button className="header-btn" onClick={() => { onTimeline(); closeMenu(); }}>Timeline</button>
          <button className="header-btn" onClick={() => { onDag(); closeMenu(); }}>Graph</button>
          <button className="header-btn" onClick={() => { onUsage(); closeMenu(); }}>Usage</button>
        </div>
        <span className="header-divider" />
        <div className="header-btn-group" title="Management">
          ...
          <button className="header-btn" onClick={() => { onGit(); closeMenu(); }}>Git</button>
        </div>
        <span className="header-divider" />
        <button className="btn-icon" onClick={() => { onSettings(); closeMenu(); }} title="Settings" aria-label="Settings">
