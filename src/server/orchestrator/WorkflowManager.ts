...
import {
  parseMilestones, ensureWorktreeBranch, countBranchCommits,
  getPrCreationOutcome, pushAndCreatePr, finalizeWorkflow, cleanupWorktree,
  _buildPrBody, BLOCKED_LOG_DIR, writeBlockedDiagnostic, updateAndEmit,
  type WorkflowPrCreationOutcome,
} from './WorkflowFinalization.js';

// Re-export public finalization API so existing callers don't need to change import paths
export {
  parseMilestones, ensureWorktreeBranch, countBranchCommits,
  getPrCreationOutcome, pushAndCreatePr, finalizeWorkflow, cleanupWorktree,
  _buildPrBody, BLOCKED_LOG_DIR, writeBlockedDiagnostic,
  type WorkflowPrCreationOutcome,
} from './WorkflowFinalization.js';
