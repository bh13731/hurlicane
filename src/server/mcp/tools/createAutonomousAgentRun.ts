...
export const createAutonomousAgentRunSchema = z.object({
  ...
  verifyCommand: z.string().optional().describe('Shell command to run after each implement phase for live verification. Exit 0 = pass, non-zero = fail. NULL = skip verify phase.'),
